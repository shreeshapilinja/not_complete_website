        ...
        card.addEventListener("click", () => {
            if (card.classList.contains("web")) {
                ...
                portfolioView({
                    ...
                    project_brief: `One of the reputed engineering colleges in the coastal
                            region of Karnataka, was established in the year 2001 by Vivekananda
                              Vidyavardhaka Sangha Puttur (R) with the vision of providing quality
                               technical education to the rural parts of coastal Karnataka. `,

                    project_date: "mail.vcetputtur.ac.in",
                    project_client: "cells.vcetputtur.ac.in",
                    project_link: `vcetputtur.ac.in`,

                    image: [
                        "resources/img/portfolios/web/coll.jpg",
                        ...
                        "resources/img/portfolios/web/3.jpg",
                        "resources/img/portfolios/web/4.jpg",
                        "resources/img/portfolios/web/index.png"
                        ],
                });
            }
            //  else if (card.classList.contains("web")) {
            //     tip.classList.add("view");
            //     let website = card
            //         .querySelector(".title")
            //         .textContent.replace(" ", "")
